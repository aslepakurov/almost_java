...
public class ConstHolder {
	...
	public static final TokenType separatorsTK[] = {TokenType.TK_S_QUOTE,TokenType.TK_S_LEFT_PARENT,TokenType.TK_S_RIGHT_PARENT,TokenType.TK_S_WS,TokenType.TK_S_CARRET,
